                ...
                <div className="project-section__wrapper">
                    ...
                    <div className="about-main__right">
                        <div className="about-main__info">
                            <p>Наш основной профиль в проектировании - это разработка проектов жилых домов. Эта
                                узконаправленная область проектирования выбрана потому, что в ней мы отлично
                                разбираемся.
                            </p>

                            <p>Благодаря разработке дизайна интерьеров параллельно с проектированием
                                дома, в мельчайших деталях прорабатываешь планировочные решения с расстановкой мебели и
                                ссылками на реальные модели мебели и оборудования.</p>

                            <p>Авторское сопровождение объектов, которое является обязательным условием, позволяет
                                реализовывать наши проекты в жизнь.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="about-team__list">
                    <div className="team-member">
                        ...
                        <div className="team-member__description">
                            Закончил Приднепровскую академию строительства и архитектуры (ПГАСА).
                            С 1998 г архитектурная деятельность.
                        </div>
                    </div>
                    <div className="team-member">
                        <div className="team-member__image">
                        ...
                        <div className="team-member__description">
                            Закончил Киевский государственный технический университет
                            строительства и архитектуры. С 2006 г архитектурная деятельность.
                        </div>
                    </div>
                    <div className="team-member">
                        <div className="team-member__image">
                        ...
                        <div className="team-member__description">
                            ...
                            С 2002 г архитектурная деятельность.
                        </div>
                    </div>
                    <div className="team-member">
                        <div className="team-member__image">
                        ...
                        <div className="team-member__description">
                            Закончила Киевский государственный университет строительства
                            и архитектуры. С 2013 г архитектурная деятельность.
                        </div>
                    </div>
                </div>
            </section>
