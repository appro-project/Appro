...
const Additional = () => {
    return <section className="project-section project-additional">
        ...
        <div className="project-section__text">
            <p>Любой проект, помимо основного состава, может быть
                дополнен по вашему желанию и нуждам.</p>
            <p>Для уточнения стоимости дополнительных услуг,
                позвоните по номеру +38 (066) 39-53-654 или
                заполните форму обратной связи и мы свяжемся с вами.</p>
        </div>
