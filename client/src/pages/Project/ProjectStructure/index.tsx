...
const ProjectStructure = () => {
    return <section className="project-section project-structure">
        ...
        <div className="project-section__text">
            <p>Приобретая проект дома в Архитектурном бюро, вы получаете комплект
                чертежей - 2 экземпляра,
                необходимый для проведения строительных работ и беспрепятственного
                получения разрешения на
                строительство.</p>
            <p>Проект содержит два раздела – Архитектурный, Конструктивный. Инженерный
                раздел и генеральный план
                можно приобрести дополнительно. Документация выдается в 2-х одинаковых
                экземплярах, средний
                размер 1 экземпляра проекта 50-70 страниц, формат А4–А3.</p>
        ...
        <div className="project-structure__wrapper">
            <div className="illustrated-list">
                ...
                <ol className="illustrated-list__content">
                    ...
                    <li>Ведомости полов, оконных и дверных проёмов, ограждающих
                        конструкций, отделки помещений,
                        заполнения проемов
                    </li>
                </ol>
            </div>
