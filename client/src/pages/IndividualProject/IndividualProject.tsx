  ...
  return (
    <div className={classes.IndividualProject}>
      <Container>
        ...
        <div className={classes['individual-project__header']}>Индивидуальный проект</div>
        <p className={classes['individual-project__description']}>
          Проект жилого дома с индивидуальными требованиями заказчика – комплексный подход специалистов (архитекторов,
          инженеров) к проектированию объекта, согласно задания на проектирование.
        </p>
        ...
        <p className={classes['individual-project__description']}>
          Так как мы проектируем, а наши компаньоны строят, нам известны определенные тонкости строительства.
        </p>
        <p className={classes['individual-project__description']}>
          Для того чтобы Ваши задуманные идеи воплотились в жизнь, мы просчитаем несколько экономически целесообразных
          вариантов и выберем наиболее выгодный.
        </p>
        <p className={classes['individual-project__description']}>
          Точно просчитанные объемы, которые входят в состав проекта, помогут нам точно определить сметную стоимость
          строительства.
        </p>
