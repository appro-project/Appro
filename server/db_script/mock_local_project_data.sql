...
INSERT INTO project(
    title, general_area, time_to_create, project_price, living_area,
...
INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/p1.jpeg', 1, true);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/pp1.jpeg', 1, false);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/p2.jpeg', 2, true);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/pp2.jpeg', 2, false);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/p3.jpeg', 3, true);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/pp3.jpeg', 3, false);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/p4.jpeg', 4, true);

INSERT INTO project_image(
    path, project_id, is_main)
VALUES ('/img/projects/pp4.jpeg', 4, false);


INSERT INTO floor(
    index, area, height, planning_image, project_id, is_attic, is_basement)
VALUES (1, 50, 2, '/img/projects/p1-plan.jpeg', 1, false, false);

INSERT INTO floor(
    area, height, project_id, is_attic, is_basement)
...
INSERT INTO floor(
    index, area, height,  project_id, is_attic, is_basement)
