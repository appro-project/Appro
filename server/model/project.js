...
const mapToProjects = (data) => {
    return _.chain(data).groupBy(function(project) { return project.id; }).map(pr => mapToProject(pr)).value()
}
...
const Project = {
    add: (project) => {
        ...
        const {title, description, popularity, generalArea,timeToCreate,projectPrice,livingArea,buildingArea,wallMaterial,
